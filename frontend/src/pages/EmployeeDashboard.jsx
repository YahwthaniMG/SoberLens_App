...
export default function EmployeeDashboard() {
  ...
  const dateStr = now.toLocaleDateString('es-MX', { weekday: 'long', day: '2-digit', month: 'long' })
      ...
      <div style={{ padding: '16px 16px 40px', display: 'flex', flexDirection: 'column', gap: 14 }}>
        ...
        {totalSessions > 0 && (
          <div style={{ display: 'flex', gap: 10 }}>
            <div style={{
              ...
              <div style={{ fontSize: 26, fontWeight: 800, color: 'var(--dark)' }}>
                {totalSessions}
              </div>
              <div style={{ fontSize: 11, color: 'var(--g1)', marginTop: 2 }}>
                Verificaciones
        ...
        <div style={{ display: 'flex', gap: 10 }}>
          ...
          >
            ...
            <div style={{ fontSize: 12, fontWeight: 600, color: 'var(--dark)' }}>Calendario</div>
          </button>
          ...
          >
            ...
            <div style={{ fontSize: 12, fontWeight: 600, color: 'var(--dark)' }}>Mi perfil</div>
          </button>
          ...
          >
            ...
            <div style={{ fontSize: 12, fontWeight: 600, color: 'var(--g1)' }}>Salir</div>
          </button>
        </div>
